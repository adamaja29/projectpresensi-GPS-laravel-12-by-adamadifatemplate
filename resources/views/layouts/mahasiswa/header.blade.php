<header class="navbar navbar-expand-md d-print-none" data-bs-theme="dark">
    <div class="container-xl" bis_skin_checked="1">
      ...
      <!-- END NAVBAR TOGGLER -->
      <!-- BEGIN NAVBAR LOGO -->
      <div class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3" bis_skin_checked="1">
      ...
      <div class="navbar-nav flex-row order-md-last" bis_skin_checked="1">
        <div class="nav-item d-none d-md-flex me-3" bis_skin_checked="1">
          <div class="btn-list" bis_skin_checked="1">
        ...
        <div class="nav-item dropdown" bis_skin_checked="1">
          <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown" aria-label="Open user menu">
              ...
              <div bis_skin_checked="1">{{ Auth::guard('mahasiswa')->user()->nama }}</div>
            
          </a>
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-theme="light" bis_skin_checked="1">
